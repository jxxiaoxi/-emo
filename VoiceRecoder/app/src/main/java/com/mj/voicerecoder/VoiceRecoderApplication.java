...
public class VoiceRecoderApplication extends Application {
    //讯飞语音开发官网　http://www.xfyun.cn/
    private static final String APPID= "594347bd";//讯飞平台申请的appId
    private DaoSession mDaoSession;
    private static VoiceRecoderApplication mContext;
    ...
    public static VoiceRecoderApplication getInstances(){
        return mContext;
    }
    ...
    private void initSpeech() {
        SpeechUtility.createUtility(VoiceRecoderApplication.this, "appid=" + APPID);
