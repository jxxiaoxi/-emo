package com.mj.voicerecoder.jpush;
...
public class JPushRecever extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        try {
            ...
            Log.d(TAG, "[MyReceiver] xxxxxxxxxxxx" +bundle.getString(JPushInterface.EXTRA_MESSAGE));
            if (JPushInterface.ACTION_REGISTRATION_ID.equals(intent.getAction())) {
                ...
                Log.d(TAG, "[MyReceiver] 用户点击打开了通知" +bundle.getString(JPushInterface.EXTRA_MESSAGE));
