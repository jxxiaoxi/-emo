...
package com.mj.voicerecoder.media;
...
public class MediaCodecWrapper {
    ...
    // Callback when com.mj.voicerecoder.media output format changes.
     ...
     *
     * @param trackFormat The format of the com.mj.voicerecoder.media object to be decoded.
    ...
    /**
     * Write a com.mj.voicerecoder.media sample to the decoder.
     *
     * A "sample" here refers to a single atomic access unit in the com.mj.voicerecoder.media stream. The definition
     ...
     *
     * @param presentationTimeUs  The time, relative to the beginning of the com.mj.voicerecoder.media stream,
     ...
     * extracts data from a stream one sample at a time.
     *
     * @param extractor  Instance of {@link android.media.MediaExtractor} wrapping the com.mj.voicerecoder.media.
     *
     * @param presentationTimeUs The time, relative to the beginning of the com.mj.voicerecoder.media stream,
     * at which this buffer should be rendered.
     *
    ...
    /**
     * Performs a peek() operation in the queue to extract com.mj.voicerecoder.media info for the buffer ready to be
